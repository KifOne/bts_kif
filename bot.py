...
job_queue.run_daily(time_now, time(20,35))
job_queue.run_daily(time_now, time(23,00))
job_queue.run_daily(time_now, time(21,00))
job_queue.run_daily(time_now, time(19,00))
job_queue.run_daily(time_now, time(17,00))
job_queue.run_daily(time_now, time(15,00))
job_queue.run_daily(time_now, time(13,00))
job_queue.run_daily(time_now, time(11,00))
job_queue.run_daily(time_now, time(9,00))
job_queue.run_daily(time_now, time(7,00))
job_queue.run_daily(time_now, time(5,00))
job_queue.run_daily(time_now, time(3,00))
job_queue.run_daily(time_now, time(1,00))
